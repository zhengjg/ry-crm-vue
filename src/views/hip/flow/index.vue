<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="flowList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="流程名" align="center" prop="flowName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="流程名" prop="flowName">
          <el-input v-model="form.flowName" placeholder="请输入流程名" />
        </el-form-item>
...
<script>
import { listFlow, getFlow, delFlow, addFlow, updateFlow } from "@/api/flow/flow";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        flowNo: [
          { required: true, message: "流程号不能为空", trigger: "blur" }
        ],
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除流程编号为"' + flowIds + '"的数据项？').then(function() {
