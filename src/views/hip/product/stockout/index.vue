<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['product:stockout:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['product:stockout:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['product:stockout:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['product:stockout:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="stockoutList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="出库Id" align="center" prop="stockOutId" />
...
<script>
import { listStockout, getStockout, delStockout, addStockout, updateStockout } from "@/api/product/stockout";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除产品出库编号为"' + stockOutIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('product/stockout/export', {
        ...this.queryParams
